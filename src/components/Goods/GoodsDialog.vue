      ...
      <div class="goods recgoods goodsdialog">
        ...
        <div class="goods_right">
          <div class="searchBox">
            <el-row>
              <el-col :span='10'>
                ...
                <el-input v-model='goods_skuname' class="search_title" size='small' placeholder="输入商品名称">
                </el-input>
              </el-col>
              <el-col :span='10'>
          ...
          <el-table :data="goodsData" border cell-class-name="brand_td" :span-method="objectSpanMethod" @row-dblclick='choiceGoods'>
            <el-table-column prop='Code' label="商品编码" align='center' width='80' :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop='NameCN' label="商品中文名称" align='center' width='150' :show-overflow-tooltip="true"></el-table-column>
            <el-table-column prop='CostPrice' label="成本价" align='center' width='80' :show-overflow-tooltip="true"></el-table-column>
