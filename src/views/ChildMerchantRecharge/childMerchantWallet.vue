<template>
  <div class="searchBox" style="padding-top:25px;">
    <el-row>
        <el-col :span='4'>
          <span class="timed">商户钱包ID：</span>
          <el-input clearable v-model="search.fundAccountId" class="search_title" size='small' placeholder="请输入商户钱包ID">
          </el-input>
        </el-col>
        <el-col :span='4'>
    ...
    <div style="padding:15px">
      <el-table :data="list" border fit highlight-current-row style="width: 100%">
          ...
          <el-table-column label='商户钱包ID' prop='FundAccountId' align='center'></el-table-column>
...
<script>
import { getChildMerchantWalletList, changeStatus } from '@/api/ChildMerchantRecharge/ChildMerchantRecharge'
...
export default {
  ...
  methods: {
    ...
    getmerchantlist() {
      ...
      getChildMerchantWalletList(this.search).then(res => {
        this.list = res.Data
